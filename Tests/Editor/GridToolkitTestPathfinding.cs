...
namespace GridToolkitTests
{
    public class Pathfinding_Tests
    {
        ...
        public void GenerateDijkstraField_NoDiagonals()
        {
            ...
            ((NextTileDirection, float), Vector2Int)[] expectedDirMap = new ((NextTileDirection, float), Vector2Int)[] { new((_dirs['.'], 0.00000f), new(6, 10)), new((_dirs['→'], 1.00000f), new(5, 10)), new((_dirs['←'], 1.00000f), new(7, 10)), new((_dirs['↓'], 1.00000f), new(6, 9)), new((_dirs['↑'], 1.00000f), new(6, 11)), new((_dirs['↓'], 2.00000f), new(5, 9)), new((_dirs['↑'], 2.00000f), new(5, 11)), new((_dirs['←'], 2.00000f), new(7, 11)), new((_dirs['←'], 2.00000f), new(8, 10)), new((_dirs['↓'], 2.00000f), new(7, 9)), new((_dirs['←'], 3.00000f), new(8, 9)), new((_dirs['←'], 3.00000f), new(9, 10)), new((_dirs['↑'], 3.00000f), new(8, 11)), new((_dirs['↑'], 3.00000f), new(7, 12)), new((_dirs['↑'], 4.00000f), new(7, 13)), new((_dirs['←'], 4.00000f), new(10, 10)), new((_dirs['↓'], 4.00000f), new(9, 9)), new((_dirs['↑'], 4.00000f), new(9, 11)), new((_dirs['←'], 5.00000f), new(10, 9)), new((_dirs['↓'], 5.00000f), new(9, 8)), new((_dirs['←'], 5.00000f), new(11, 10)), new((_dirs['↑'], 5.00000f), new(10, 11)), new((_dirs['←'], 5.00000f), new(8, 13)), new((_dirs['↑'], 5.00000f), new(7, 14)), };
            Assert.AreEqual(expectedDirMap.Length, dirMap.AccessibleTilesCount);
            for (int i = 0; i < dirMap._accessibleTiles.Count; i++)
            {
                var pair = dirMap._accessibleTiles.ElementAt(i);
                NextTileDirection actualDir = pair.Value.Item1;
        ...
        public void GenerateDijkstraField_AllDiagonals()
        {
            ...
            ((NextTileDirection, float), Vector2Int)[] expectedDirMap = new ((NextTileDirection, float), Vector2Int)[] { new((_dirs['.'], 0.000f), new(6, 10)), new((_dirs['→'], 1.000f), new(5, 10)), new((_dirs['←'], 1.000f), new(7, 10)), new((_dirs['↓'], 1.000f), new(6, 9)), new((_dirs['↑'], 1.000f), new(6, 11)), new((_dirs['↘'], 1.414f), new(5, 9)), new((_dirs['↙'], 1.414f), new(7, 9)), new((_dirs['↗'], 1.414f), new(5, 11)), new((_dirs['↖'], 1.414f), new(7, 11)), new((_dirs['←'], 2.000f), new(8, 10)), new((_dirs['↙'], 2.414f), new(8, 9)), new((_dirs['↖'], 2.414f), new(8, 11)), new((_dirs['↖'], 2.414f), new(7, 12)), new((_dirs['←'], 3.000f), new(9, 10)), new((_dirs['↙'], 3.414f), new(9, 9)), new((_dirs['↖'], 3.414f), new(9, 11)), new((_dirs['↙'], 3.828f), new(9, 8)), new((_dirs['↑'], 3.414f), new(7, 13)), new((_dirs['↖'], 3.828f), new(8, 13)), new((_dirs['←'], 4.000f), new(10, 10)), new((_dirs['↙'], 4.414f), new(10, 9)), new((_dirs['↖'], 4.414f), new(10, 11)), new((_dirs['↑'], 4.414f), new(7, 14)), new((_dirs['↗'], 4.828f), new(6, 14)), new((_dirs['↖'], 4.828f), new(8, 14)), new((_dirs['←'], 4.828f), new(9, 13)), new((_dirs['↓'], 4.828f), new(9, 7)), new((_dirs['←'], 5.000f), new(11, 10)), };
            Assert.AreEqual(expectedDirMap.Length, dirMap.AccessibleTilesCount);
            for (int i = 0; i < dirMap._accessibleTiles.Count; i++)
            {
                var pair = dirMap._accessibleTiles.ElementAt(i);
        ...
        public void GenerateDijkstraField_TwoFreeDiagonals()
        {
            ...
            ((NextTileDirection, float), Vector2Int)[] expectedDirMap = new ((NextTileDirection, float), Vector2Int)[] { new((_dirs['.'], 0.000f), new(6, 10)), new((_dirs['→'], 1.000f), new(5, 10)), new((_dirs['←'], 1.000f), new(7, 10)), new((_dirs['↓'], 1.000f), new(6, 9)), new((_dirs['↑'], 1.000f), new(6, 11)), new((_dirs['↘'], 1.414f), new(5, 9)), new((_dirs['↙'], 1.414f), new(7, 9)), new((_dirs['↗'], 1.414f), new(5, 11)), new((_dirs['↖'], 1.414f), new(7, 11)), new((_dirs['←'], 2.000f), new(8, 10)), new((_dirs['↙'], 2.414f), new(8, 9)), new((_dirs['↖'], 2.414f), new(8, 11)), new((_dirs['↑'], 2.414f), new(7, 12)), new((_dirs['←'], 3.000f), new(9, 10)), new((_dirs['↙'], 3.414f), new(9, 9)), new((_dirs['↖'], 3.414f), new(9, 11)), new((_dirs['↑'], 3.414f), new(7, 13)), new((_dirs['←'], 4.000f), new(10, 10)), new((_dirs['↙'], 4.414f), new(10, 9)), new((_dirs['↖'], 4.414f), new(10, 11)), new((_dirs['←'], 4.414f), new(8, 13)), new((_dirs['↑'], 4.414f), new(7, 14)), new((_dirs['↖'], 4.828f), new(8, 14)), new((_dirs['↓'], 4.414f), new(9, 8)), new((_dirs['←'], 5.000f), new(11, 10)), };
            Assert.AreEqual(expectedDirMap.Length, dirMap.AccessibleTilesCount);
            for (int i = 0; i < dirMap._accessibleTiles.Count; i++)
            {
                var pair = dirMap._accessibleTiles.ElementAt(i);
        ...
        [Test]
        public void DirectionAtlas_HasPath()
        {
            int targetX = 6;
            int targetY = 10;
            int accessibleTileX = 2;
            ...
            int inaccessibleTileY = 3;
            TestTile target = GridUtils.GetTile(_grid, targetX, targetY);
            DirectionAtlas dirAtlas = Pathfinding.GenerateDirectionAtlas(_grid);
            Assert.IsTrue(dirAtlas.HasPath(_grid, GridUtils.GetTile(_grid, accessibleTileX, accessibleTileY), target));
            Assert.IsFalse(dirAtlas.HasPath(_grid, GridUtils.GetTile(_grid, inaccessibleTileX, inaccessibleTileY), target));
        }
        [TestCase(false, false)]
        [TestCase(true, false)]
        [TestCase(false, true)]
        [TestCase(true, true)]
        public void DirectionAtlas_GetPathToTarget_NoDiagonals(bool includeStart, bool includeTarget)
        {
            int targetX = 6;
            int targetY = 10;
            int startX = 2;
            ...
            TestTile targetTile = includeTarget ? target : null;
            TestTile startTile = includeStart ? start : null;
            TestTile[] returnedPath = dirAtlas.GetPath(_grid, start, target, includeStart, includeTarget);
            List<TestTile> expectedPathList = new(){
                startTile, new(2,11), new(2,12), new(2,13), new(2,14), new(1,14), new(1,15), new(1,16), new(2,16), new(3,16), new(4,16), new(5,16), new(6,16), new(7,16), new(7,15), new(7,14), new(7,13), new(7,12), new(7,11), new(7,10), targetTile
            };
            TestTile[] expectedPath = expectedPathList.Where(x => x != null).ToArray();
        ...
        [TestCase(false, true)]
        [TestCase(true, true)]
        public void DirectionAtlas_GetPathToTarget_AllDiagonals(bool includeStart, bool includeTarget)
        {
            int targetX = 6;
            int targetY = 10;
            int startX = 2;
        ...
        [TestCase(false, true)]
        [TestCase(true, true)]
        public void DirectionAtlas_GetPathToTarget_Diagonals1Free(bool includeStart, bool includeTarget)
        {
            int targetX = 6;
            int targetY = 10;
            int startX = 2;
        ...
        [TestCase(false, true)]
        [TestCase(true, true)]
        public void DirectionAtlas_GetPathToTarget_Diagonals2Free(bool includeStart, bool includeTarget)
        {
            int targetX = 6;
            int targetY = 10;
            int startX = 2;
        ...
        public void DirectionAtlas_GetNextTileDirectionFromTile_NoDiagonals()
        {
            ...
            TestTile start = GridUtils.GetTile(_grid, startX, startY);
            DirectionAtlas dirAtlas = Pathfinding.GenerateDirectionAtlas(_grid, DiagonalsPolicy.NONE);
            NextTileDirection returnedDir = dirAtlas.GetNextTileDirectionFromTile(_grid, start, target);
            NextTileDirection expectedDir = NextTileDirection.LEFT;
            Assert.AreEqual(expectedDir, returnedDir);
        }
        [Test]
        ...
        [Test]
        public void DirectionAtlas_Serialization()
        {
            int targetX = 6;
            int targetY = 10;
            int startX = 10;
            ...
            TestTile start = GridUtils.GetTile(_grid, startX, startY);
            DirectionAtlas dirAtlas = Pathfinding.GenerateDirectionAtlas(_grid);
            byte[] serializedDirMap = dirAtlas.ToByteArray();
            DirectionAtlas deserializedDirMap = DirectionAtlas.FromByteArray(_grid, serializedDirMap);
            Assert.AreEqual(dirAtlas._directionAtlas.Length, deserializedDirMap._directionAtlas.Length);
            for (int i = 0; i < deserializedDirMap._directionAtlas.Length; i++)
            {
                if (dirAtlas._directionAtlas[i] == null)
                {
                    continue;
                }
                for (int j = 0; j < dirAtlas._directionAtlas[i]._directionGrid.Length; j++)
                {
                    Assert.AreEqual(dirAtlas._directionAtlas[i]._directionGrid[j], deserializedDirMap._directionAtlas[i]._directionGrid[j], $"i:{i} j:{j} Should be {dirAtlas._directionAtlas[i]._directionGrid[j]} but is actually {deserializedDirMap._directionAtlas[i]._directionGrid[j]}");
                }
            }
        }
        ...
        #region DijkstraAtlas

        [Test]
        public void DijkstraAtlas_HasPath()
        {
            int targetX = 6;
            int targetY = 10;
            int accessibleTileX = 2;
            ...
            int inaccessibleTileY = 3;
            TestTile target = GridUtils.GetTile(_grid, targetX, targetY);
            DijkstraAtlas dijAtlas = Pathfinding.GenerateDijkstraAtlas(_grid);
            Assert.IsTrue(dijAtlas.HasPath(_grid, GridUtils.GetTile(_grid, accessibleTileX, accessibleTileY), target));
            Assert.IsFalse(dijAtlas.HasPath(_grid, GridUtils.GetTile(_grid, inaccessibleTileX, inaccessibleTileY), target));
        }
        [TestCase(false, false)]
        [TestCase(true, false)]
        [TestCase(false, true)]
        [TestCase(true, true)]
        public void DijkstraAtlas_GetPathToTarget_NoDiagonals(bool includeStart, bool includeTarget)
        {
            int targetX = 6;
            int targetY = 10;
            int startX = 2;
            ...
            TestTile targetTile = includeTarget ? target : null;
            TestTile startTile = includeStart ? start : null;
            TestTile[] returnedPath = dijAtlas.GetPath(_grid, start, target, includeStart, includeTarget);
            List<TestTile> expectedPathList = new(){
                startTile, new(2,11), new(2,12), new(2,13), new(2,14), new(1,14), new(1,15), new(1,16), new(2,16), new(3,16), new(4,16), new(5,16), new(6,16), new(7,16), new(7,15), new(7,14), new(7,13), new(7,12), new(7,11), new(6,11), targetTile
            };
            TestTile[] expectedPath = expectedPathList.Where(x => x != null).ToArray();
        ...
        [TestCase(false, true)]
        [TestCase(true, true)]
        public void DijkstraAtlas_GetPathToTarget_AllDiagonals(bool includeStart, bool includeTarget)
        {
            int targetX = 6;
            int targetY = 10;
            int startX = 2;
        ...
        [TestCase(false, true)]
        [TestCase(true, true)]
        public void DijkstraAtlas_GetPathToTarget_Diagonals1Free(bool includeStart, bool includeTarget)
        {
            int targetX = 6;
            int targetY = 10;
            int startX = 2;
        ...
        [TestCase(false, true)]
        [TestCase(true, true)]
        public void DijkstraAtlas_GetPathToTarget_Diagonals2Free(bool includeStart, bool includeTarget)
        {
            int targetX = 6;
            int targetY = 10;
            int startX = 2;
        ...
        public void DijkstraAtlas_GetNextTileDirectionFromTile_NoDiagonals()
        {
            ...
            TestTile start = GridUtils.GetTile(_grid, startX, startY);
            DijkstraAtlas dijAtlas = Pathfinding.GenerateDijkstraAtlas(_grid, DiagonalsPolicy.NONE);
            NextTileDirection returnedDir = dijAtlas.GetNextTileDirectionFromTile(_grid, start, target);
            NextTileDirection expectedDir = NextTileDirection.LEFT;
            Assert.AreEqual(expectedDir, returnedDir);
        }
        [Test]
        ...
        [Test]
        public void DijkstraAtlas_Serialization()
        {
            int targetX = 6;
            int targetY = 10;
            int startX = 10;
            ...
            TestTile target = GridUtils.GetTile(_grid, targetX, targetY);
            TestTile start = GridUtils.GetTile(_grid, startX, startY);
            DijkstraAtlas dirAtlas = Pathfinding.GenerateDijkstraAtlas(_grid);
            byte[] serializedDirMap = dirAtlas.ToByteArray();
            DijkstraAtlas deserializedDirMap = DijkstraAtlas.FromByteArray(_grid, serializedDirMap);
            Assert.AreEqual(dirAtlas._dijkstraAtlas.Length, deserializedDirMap._dijkstraAtlas.Length);
            for (int i = 0; i < deserializedDirMap._dijkstraAtlas.Length; i++)
            {
                if (dirAtlas._dijkstraAtlas[i] == null)
                {
                    continue;
                }
                for (int j = 0; j < dirAtlas._dijkstraAtlas[i]._directionGrid.Length; j++)
                {
                    Assert.AreEqual(dirAtlas._dijkstraAtlas[i]._directionGrid[j], deserializedDirMap._dijkstraAtlas[i]._directionGrid[j], $"i:{i} j:{j} Should be {dirAtlas._dijkstraAtlas[i]._directionGrid[j]} but is actually {deserializedDirMap._dijkstraAtlas[i]._directionGrid[j]}");
                }
            }
        }
        [Test]
        public void DijkstraAtlas_GetDistanceToTarget()
        {
            int targetX = 6;
            int targetY = 10;
            int startX = 2;
            ...
            TestTile start = GridUtils.GetTile(_grid, startX, startY);
            DijkstraAtlas dijAtlas = Pathfinding.GenerateDijkstraAtlas(_grid);
            Assert.IsTrue(Mathf.Approximately(20f, dijAtlas.GetDistanceBetweenTiles(_grid, start, target)));
        }
        #endregion
    }
}