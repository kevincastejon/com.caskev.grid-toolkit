...
namespace Caskev.GridToolkit
{
    ...
    public class DijkstraField : DijkstraBase
    {
        ...
        internal DijkstraField(float maxDistance, int[] accessibleTilesFlatIndexes, NextTileDirection[] directionGrid, float[] distanceGrid, int target) : base(directionGrid, distanceGrid, target)
        {
