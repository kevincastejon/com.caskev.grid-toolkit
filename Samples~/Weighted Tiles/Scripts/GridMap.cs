...
namespace GridToolkitWorkingProject.Samples.WeightedTiles
{
    public class GridMap : MonoBehaviour
    {
        ...
        private DijkstraGrid _globalDijkstraGrid;
        ...
        {
            _pathTiles = _globalDijkstraGrid.GetPathFromTarget(_map, _startTile);
        ...
        private void GenerateDijkstraGrid()
        {
            // Generating a path map
            _globalDijkstraGrid = Pathfinding.GenerateDijkstraGrid(_map, _targetTile);
        }
        public void ShowDistances()
        {
            ...
            for (int i = 0; i < _map.GetLength(0); i++)
            {
                ...
                {
                    _map[i, j].ShowDistance(_globalDijkstraGrid.GetDistanceToTarget(_map, _map[i, j]));
                }
            }
        }
